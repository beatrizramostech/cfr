...
import './index.css';
import AvariaItem from '../AvariaItem';
        ...
        <div className="form-grid">
          ...
          <label htmlFor="">
            ...
            >
              ...
              <option value="1/4 DO TANQUE">1/4 DO TANQUE</option>
              <option value="METADE DO TANQUE">METADE DO TANQUE</option>
              <option value="3/4 DO TANQUE">3/4 DO TANQUE</option>
